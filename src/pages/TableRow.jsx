    ...
    return (
        <tr>
            <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <div className="inline-flex items-center gap-x-3">
                    <div className="flex items-center gap-x-2">
                        <img className="object-cover w-28 h-20 rounded-lg" src={image} alt="" />
            ...
            <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                <div>
                    <h2 className="font-medium text-gray-800 dark:text-white">{roomType}</h2>
                    <p className="text-sm font-normal text-gray-600 dark:text-gray-400">{roomCharacteristics}</p>
                </div>
            </td>
            ...
            <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"> <strong>${price}</strong> </td>
            <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap"> <strong> {format(new Date(date
            ...
            <td className="px-4 py-4 text-sm whitespace-nowrap">
                <div className="flex items-center gap-x-6">
                    ...
                    {/* Delete Button */}
                    <button onClick={() => handleDelete(room._id, roomId)}
